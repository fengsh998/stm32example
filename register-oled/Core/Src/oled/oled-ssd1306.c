...
/**
 *  Simple 8x8 font (ASCII 32-126, from common open source examples like u8g2 or afiskon)
 *
 *  8x8的显示不了中文的，不够大至少16x16及以上才能显示完整
 */
const uint8_t font8x8[95][8] = {
    ...
    {0x00, 0x04, 0x7F, 0x44, 0x24, 0x00, 0x00, 0x00}, // 't'
